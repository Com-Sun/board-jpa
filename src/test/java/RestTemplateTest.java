...
public class RestTemplateTest {
    ...
    public void getForEntity() {
        ResponseEntity<Post> responseEntity =
            restTemplate.getForEntity(uriComponents.toUri(), Post.class);
        log.debug("post:{}", responseEntity.getBody());
    ...
    public void getAllPostForEntity() {
        ResponseEntity<Post[]> responseEntity =
            restTemplate.getForEntity(uriComponentsAll.toUri(), Post[].class);
    ...
    public void exchange() {
        ...
        ResponseEntity<Post> responseEntity =
            restTemplate.exchange(uriComponents.toUri(), HttpMethod.GET, httpEntity, Post.class);
    ...
    public void exchangeAll() {
        ...
        HttpEntity httpEntity = new HttpEntity(headers);
        ResponseEntity<Post[]> responseEntity =
            restTemplate.exchange(uriComponentsAll.toUri(), HttpMethod.GET, httpEntity,
                Post[].class);
        for (Post post : responseEntity.getBody()) {
            log.debug("post:{}", post);
        }
